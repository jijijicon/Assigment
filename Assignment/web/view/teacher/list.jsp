<%-- 
    Document   : list
    Created on : Mar 11, 2022, 12:15:51 AM
    Author     : ASUS
--%>
            ...
            <div class="content">
                ...
                <table  class="table table-striped table-hover table1">
                    ...
                    <tr>
                        ...
                        <td><%= teachers.get(i).getLastname() %></td>
                        <td><%= teachers.get(i).getFirstname()%></td>
                        <td><% if (teachers.get(i).isGender()) { %>nam<%} else { %>nữ<%}%></td>
                        <td><a href="../teacher/infor?id=<%= teachers.get(i).getTeacherID() %>">detail</a></td>
                ...
                <a href="../teacher/insert" class="btn btn-primary">thêm giáo viên</a>   
                <div id="pagger"></div>
